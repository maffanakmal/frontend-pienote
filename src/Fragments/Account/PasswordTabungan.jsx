                    ...
                    <Row className="d-flex gap-5 pt-5">
                        <Col sm={3} className="d-flex flex-column shadow-sm block vh-100">
                            ...
                            <div className="d-flex flex-column gap-1 mt-5">
                                ...
                                <Button onClick={btnCatatanTabungan} variant="primary" size="xl" className="text-start shadow-sm" active>
                                    Catatan Tabungan
                                </Button>
                                <Button onClick={btnCatatanKeuangan} variant="outline-primary" size="xl" className="text-start shadow-sm">
                                    Catatan Keuangan
                                </Button>
                            </div>
                        </Col>
                        ...
                        <Col sm={7}>
                            <h4>Catatan Tabungan</h4>
                            <Row className="mt-5 d-flex flex-column justify-content-center text-center">
                                <Alert show={showAlert} variant="success" onClose={() => setShowAlert(false)} dismissible>
                                    <h5>Success! </h5>
                                    <p>Selamat datang di Catatan Tabungan, Jidan Ilham!</p>
                                </Alert>
                                <h4>Enter Password Code</h4>
                                <p>Please enter any 4 digit that you will use to unblock your saving notes</p>
